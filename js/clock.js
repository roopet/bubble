// Based on http://clockVis.stanford.edu/protoclockVis/ex/clock.html
...
var clockVis = d3.select("#clock").append("svg")
    .attr("width", w)
    .attr("height", h)
  .append("g")
    .attr("transform", "translate(" + w / 2 + "," + h / 2 + ")");

var g = clockVis.selectAll("g")
    .data(fields)
  .enter().append("g");
...
function fields() {
  var d = new Date;
// d3.csv("data/agents.csv", function(csv){
//   alert(csv[1].timeinstate);
// })
  // function days() {
  //   return 32 - new Date(d.getYear(), d.getMonth(), 32).getDate();
  // }
  // var seconds=(nStr/1000)%60, 
  //     minutes=(nStr/(1000*60))%60, 
  //     hours=(nStr/(1000*60*60))%24;
